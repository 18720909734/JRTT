...
public final class NewsMainModule_ProvideMainPresenterFactory implements Factory<IRxBusPresenter> {
  ...
  public NewsMainModule_ProvideMainPresenterFactory(
      NewsMainModule module,
  ...
  public IRxBusPresenter get() {
    return Preconditions.checkNotNull(
        module.provideMainPresenter(daoSessionProvider.get(), rxBusProvider.get()),
  ...
  public static Factory<IRxBusPresenter> create(
      ...
      Provider<DaoSession> daoSessionProvider,
      Provider<RxBus> rxBusProvider) {
    return new NewsMainModule_ProvideMainPresenterFactory(
