...
public final class DownloadActivity_MembersInjector implements MembersInjector<DownloadActivity> {
  ...
  public static MembersInjector<DownloadActivity> create(
      Provider<IRxBusPresenter> mPresenterProvider,
      Provider<ViewPagerAdapter> mPagerAdapterProvider) {
    return new DownloadActivity_MembersInjector(mPresenterProvider, mPagerAdapterProvider);
  }
  ...
  public static void injectMPagerAdapter(
      DownloadActivity instance, Provider<ViewPagerAdapter> mPagerAdapterProvider) {
    instance.mPagerAdapter = mPagerAdapterProvider.get();
  }
}
