...
public final class BigPhotoModule_ProvidePresenterFactory implements Factory<ILocalPresenter> {
  ...
  public BigPhotoModule_ProvidePresenterFactory(
      BigPhotoModule module,
  ...
  public static Factory<ILocalPresenter> create(
      ...
      Provider<DaoSession> daoSessionProvider,
      Provider<RxBus> rxBusProvider) {
    return new BigPhotoModule_ProvidePresenterFactory(module, daoSessionProvider, rxBusProvider);
  }
}
